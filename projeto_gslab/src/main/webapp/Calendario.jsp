...
<div class="table-container">
    ...
    <form action="Reserva" method="post" onsubmit="return sendFormData()">
        <input class="selector" type="date" id="dateSelector" onchange="updateHeaders()">
        ...
        <table class="table table-bordered">
            ...
            <script>
                ...
                function sendFormData() {
                    ...
                    document.getElementById('dataInput').value = selectedDate;
                    var selectedCellsInput = document.createElement('input');
                    selectedCellsInput.type = 'hidden';
                    selectedCellsInput.name = 'selectedCells';
                    selectedCellsInput.value = selectedCells.join(';');
                    document.querySelector('form').appendChild(selectedCellsInput);
                    console.log("celulas jsp: " + selectedCells); // Imprime a lista de células selecionadas no console
